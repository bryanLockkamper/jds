...
Insert into Groupe (Nom) values ('ForeverAlone');

insert into UTILISATEUR_GROUPES (GROUPES_ID, UTILISATEURDALLIST_ID) VALUES (1,1);

Insert into Rencontre ( Date, Description, Nbr_Participant_Limite, Temps_De_Jeu, Titre, Adresse_id, groupe_crea_id ) values ('2018-09-24', 'TestTestTestTestTest', 15, 160, 'Test', 1,1), ('2020-09-24', 'TestTestTestTestTest1', 15, 160, 'Test1', 1,1);

Insert into Role (Nom) values ('ROLE_ADMIN'), ('UtilisateurLambda');
