...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatchers("/creerUtilisateur").hasRole("ADMIN")
                .antMatchers("/supprimerUtilisateur").hasRole("ADMIN")
                .antMatchers("/modifierUtilisateur").authenticated()
                .antMatchers("/utilisateur/1/groupes").permitAll()
